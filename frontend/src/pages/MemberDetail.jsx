...
export default function MemberDetail(){
  ...
  const {history=[], warnings=[], alerts=[], state, war_history=[], capital_history=[], stats={}} = data || {}
  ...
  return <div className="space-y-6">
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="card p-4">
        ...
        <div className="text-2xl font-black mt-1">{stats.wars_entered??war_history.length} <span className="text-sm font-normal text-zinc-500">/ {stats.wars_with_attack??0} con ataque</span></div>
        <div className="text-xs text-zinc-500 mt-1">{stats.wars_missed??0} sin atacar · ★ {stats.stars_total??0} estrellas</div>
      </div>
      <div className="card p-4">
        <div className="text-xs uppercase tracking-widest font-semibold text-zinc-500">Capital</div>
        <div className="text-2xl font-black mt-1">{stats.capital_total??0} <span className="text-sm font-normal text-zinc-500">/ 5 por finde</span></div>
      ...
      <div className="card p-4">
        <div className="text-xs uppercase tracking-widest font-semibold text-zinc-500">Warnings</div>
        <div className="text-2xl font-black mt-1">{warnings.length}</div>
        <div className="text-xs text-zinc-500 mt-1">Vencimiento 30/60/90 días</div>
      </div>
    </div>
